...
const Annotate: React.FC<ArticleType> = ({
	...
	return (
		<>
			<Link
				href={path as '/'}
				className="block px-6 pt-5 md:pt-7  md:w-621 md:border-2 md:rounded-xl md:border-PrimaryColor-20 hover:bg-PrimaryColor-5 md:mb-4"
			>
				...
				<div className="flex items-center pb-7 border-b-2 md:border-0 border-PrimaryColor">
