    ...
    <>
      ...
      <div className="relative px-5 py-4 hidden md:flex w-full justify-center">
        <Link href="/books" className="flex absolute left-4 pt-1">
          ...
          <div className=" ml-2">{stringBooks("title")}</div>
        </Link>
        <div className="flex flex-col">
          <div
            className={`text-2xl line-clamp-2 ${cormorant_Garamond.className} text-center px-2`}
        ...
        <div className={`flex justify-between py-4 ${inter.className}`}>
          <div className="flex items-center ">
            ...
            <button className="flex items-center ">
              ...
              <div className="">{stringTools("search")}</div>
            </button>
          </div>
          <div className="flex ">
            <button>
