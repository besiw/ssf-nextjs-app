...
const Sidebar: React.FC<FilterProps> = ({
	...
	return (
		<div className={`relative pr-4 z-20 xl:pl-4 ${varta.className}`}>
			<form className="px-5 text-start bg-gray-75 rounded-r-3xl overflow-hidden">
...
const SidebarButton: React.FC<SidebarButtonProps> = ({ buttonBody }) => {
	return (
		<button className="w-full h-11 border flex items-center justify-center bg-white text-PrimaryColor border-PrimaryColor rounded-full mb-7 pt-1">
			{buttonBody}
		</button>
	);
};
