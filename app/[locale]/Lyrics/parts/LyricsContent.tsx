  ...
  return (
    <>
      <main className="md:flex flex-col justify-start items-center px-5 md:mb-10">
        <div className="flex items-center  md:max-w-xl w-full dark:text-white-darkText01 ">
          <div
        ...
        <div className="md:hover:bg-PrimaryColor-12 md:bg-gray-30 md:max-w-xl md:w-full md:rounded-2xl md:mt-8 dark:text-white-darkText01">
          <section
